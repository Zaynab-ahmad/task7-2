...
import { BsTelephoneFill, BsArrowRight } from "react-icons/bs";
...
export default function Footer() {
  ...
  return (
    <>
      <div className="mainFooter w-100 bg-dark text-white"  
       style={{ marginTop: location.pathname === '/' ? "100px" : "0" }}
>
      <div className="exContainer position-relative py-4">
        {location.pathname === '/' && <HomeFooter />}
        {(location.pathname === '/about' || location.pathname === '/contact') && <AboutFooter />}
          <Row className="footer pt-5">
            <Col xs={12} lg={3}>
              ...
              <p className="py-2" style={{ fontSize: "12px" }}>
                ...
                Aliquam, sint neque. Explicabo reprehenderit praesentium
              </p>
              <div>
                <span className="footerIcon">
                  <FaFacebookF style={{ fontSize: "10px" }} />
                </span>
                <span className="footerIcon">
                  <FaTwitter style={{ fontSize: "10px" }} />
                </span>
                <span className="footerIcon">
                  <FaYoutube style={{ fontSize: "10px" }} />
                </span>
                <span className="footerIcon">
                  <FaInstagram style={{ fontSize: "10px" }} />
                </span>
              </div>
            </Col>

            <Col xs={12} lg={2} mx-lg-2>
              <h3 className="my-4 fs-6 footerTitle">Quick Links</h3>
              <p className="py-2" style={{ fontSize: "12px" }}>
                <PiCaretDoubleRight className="fs-6" Link to="/about" /> Extech
                About
              </p>
              <p className="py-1" style={{ fontSize: "12px" }}>
                <PiCaretDoubleRight className="fs-6" /> Our Services
              </p>
              <p className="py-1" style={{ fontSize: "12px" }}>
                <PiCaretDoubleRight className="fs-6" /> Our Blog
              </p>
              <p className="py-1" style={{ fontSize: "12px" }}>
                <PiCaretDoubleRight className="fs-6" /> FAQs
              </p>
              <p className="py-1" style={{ fontSize: "12px" }}>
                <PiCaretDoubleRight className="fs-6" Link to="/contact" />{" "}
                Contact Us
              </p>
            </Col>

            <Col xs={12} lg={3}>
              <h3 className="my-4 fs-6 footerTitle">Resent Posts</h3>
              ...
              <div className="d-flex mb-3">
                ...
                <div className="mx-2" style={{ textAlign: "start" }}>
                  ...
                  <p className="my-0" style={{fontSize: "0.9em" }}> Top Most 5 Famous Technology trends</p>
                </div>
              </div>
            ...
            <Col xs={12} lg={4}>
              <h3 className="my-4 fs-6 footerTitle">Contact Us</h3>
              <form>
                <p>
                  <IoIosMail className="fs-5" /> info@example.com
                </p>
                <p>
                  <BsTelephoneFill className="fs-5" /> +208-6666-0112
                </p>
                <div
                  className="bg-white p-2 d-flex justify-content-between"
                  style={{ borderRadius: "7px", width: "fit-content" }}
                >
                  <input
                ...
                >
                  ...
                  />
                  <label htmlFor="privacy" style={{ color: "white" }}>
                    I Agree to the{" "}
      ...
      >
        <div className="exContainer pt-4 ">
          <Row className="d-flex flex-column flex-lg-row justify-content-between align-items-center">
            <Col
              xs={12}
              lg={3}
              className="d-flex justify-content-center justify-content-lg-start"
            >
              © All Copyright 2024 By Extech
            </Col>
            <Col xs={12} lg={3} className="d-flex justify-content-evenly g-3">
              <a>Terms and Condition</a> <a>Privacy Policy</a>
            </Col>
          </Row>
        </div>
      </div>
